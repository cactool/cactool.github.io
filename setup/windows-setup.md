...
## 1. Installing Docker: Enabling WSL.
Docker has their own guide to installing Docker for Windows here: https://docs.docker.com/desktop/install/windows-install/

The first step is making sure you have enabled Windows Subsystem for Linux (WSL). This allows Docker to run correctly. In Windows 10, go to your search bar and type “Turn Windows Features On and Off” and click on the on the returned result.
...
To download Docker, go to https://www.docker.com/ and download the most current version. When downloaded, install this. This should take enough time for you to grab a coffee.
